...
public class SubscriptionService : ISubscriptionService
{
    ...
    public async Task<UserSubscription> CreateSubscriptionAsync(int customerId, int packageId, double price)
    {
    ...
    public async Task<List<UserSubscription>> GetActiveSubscriptionAsync(int customerId)
    {
