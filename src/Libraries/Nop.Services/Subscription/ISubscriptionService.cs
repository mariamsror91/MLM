...
public interface ISubscriptionService
{
    ...
    Task<UserSubscription> CreateSubscriptionAsync(int customerId, int packageId, double price);
    Task<List<UserSubscription>> GetActiveSubscriptionAsync(int customerId);
